...
pub fn start(args: &mut [String]) {
    ...
    #[cfg(all(target_os = "linux", feature = "inline"))]
    {
        ...
        let mut so_path = "/usr/share/emudesk/libsciter-gtk.so".to_owned();
        for (prefix, dir) in [
            ("", "/usr"),
            ("", "/app"),
            (&app_dir, "/usr"),
        ...
        .iter()
        {
            let path = format!("{prefix}{dir}/share/emudesk/libsciter-gtk.so");
    ...
    // https://github.com/emudesk/emudesk/issues/132#issuecomment-886069737
    #[cfg(windows)]
