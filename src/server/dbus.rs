...
///
/// Note:
/// On linux, we use dbus to communicate between multiple emudesk processes.
...
const DBUS_NAME: &str = "org.emudesk.emudesk";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "emudesk DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.emudesk.emudesk /dbus org.emudesk.emudesk.NewConnection string:'PEER_ID'`
