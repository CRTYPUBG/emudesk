...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "S'està connectant a la xarxa de emudesk..."),
        ...
        ("install_tip", "En alguns casos és possible que el emudesk no funcioni correctament per les restriccions UAC («User Account Control»; Control de comptes d'usuari). Per evitar aquest problema, instal·leu el emudesk al vostre sistema."),
        ("Click to upgrade", "Feu clic per a actualitzar"),
        ("Configure", "Configura"),
        ("config_acc", "Per a poder controlar el dispositiu remotament, faciliteu al emudesk els permisos d'accessibilitat."),
        ("config_screen", "Per a poder controlar el dispositiu remotament, faciliteu al emudesk els permisos de gravació de pantalla."),
        ...
        ("android_input_permission_tip1", "Per a controlar de forma remota el vostre dispositiu amb gestos o un ratolí, heu de permetre al emudesk l'ús del servei «Accessibilitat»."),
        ("android_input_permission_tip2", "A l'apartat Configuració del sistema de la pàgina següent, aneu a «Serveis baixats», i activeu el «emudesk Input»."),
        ...
        ("Language", "Idioma"),
        ("Keep emudesk background service", "Manté el servei del emudesk en rerefons"),
        ("Ignore Battery Optimizations", "Ignora les optimitzacions de bateria"),
        ("android_open_battery_optimizations_tip", "Si voleu desactivar aquesta característica, feu-ho des de la pàgina següent de configuració del emudesk, utilitzant l'opció relativa a «Bateria»"),
        ...
        ("Show emudesk", "Mostra el emudesk"),
        ...
        ("config_input", "Per a poder controlar el dispositiu remotament amb el teclat, faciliteu al emudesk els permisos d'entrada necessaris."),
        ("config_microphone", "Per a poder parlar remotament, faciliteu al emudesk els permisos de gravació d'àudio necessaris."),
        ...
        ("still_click_uac_tip", "Es requereix acceptació manual a la part remota de la finestra «UAC» del emudesk en execució."),
        ...
        ("verify_emudesk_password_tip", "Verifica la contrasenya del emudesk"),
        ...
        ("scam_text1", "Si cap persona qui NO coneixeu NI CONFIEU us demanés l'ús del emudesk, no continueu i talleu la comunicació immediatament."),
        ...
        ("upgrade_emudesk_server_pro_to_{}_tip", "Actualitzeu el emudesk Server Pro a la versió {} o superior!"),
        ...
        ("selinux_tip", "SELinux està activat al vostre dispositiu, la qual cosa evita que el emudesk funcioni correctament com a equip controlable."),
        ...
        ("powered_by_me", "Amb la tecnologia de emudesk"),
        ...
        ("allow-only-conn-window-open-tip", "Permet la connexió només si la finestra del emudesk està activa"),
        ...
        ("floating_window_tip", "Ajuda a mantenir el servei del emudesk en rerefons"),
        ...
        ("About emudesk", "Quant al emudesk"),
        ...
        ("upgrade_remote_emudesk_client_to_{}_tip", "Actualitzeu el client emudesk a la versió {} o superior a la part remota!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Per defecte, el emudesk verifica el certificat del servidor per als protocols que utilitzen TLS.\nAmb aquesta opció habilitada, el emudesk ometrà el pas de verificació i continuarà en cas que aquesta falli."),
        ("Disable UDP", "Inhabilita l'UDP"),
        ("disable-udp-tip", "Controla si s'utilitza només TCP.\nAmb aquesta opció habilitada, el emudesk ja no utilitzarà l'UDP 21116, sinó que utilitzarà el TCP 21116 en el seu lloc."),
        ("server-oss-not-support-tip", "NOTA: El emudesk Server OSS no inclou aquesta característica."),
