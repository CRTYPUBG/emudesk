...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem emudesk..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, emudesk v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate emudesku dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate emudesku dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno emudesku dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »emudesk Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep emudesk background service", "Ohrani emudeskovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije emudesk, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "emudesk potrebuje pravico »Nadzor vnosa« za nadzor oddaljenega namizja s tipkovnico."),
        ("config_microphone", "emudesk potrebuje pravico »Snemanje zvoka« za zajemanje zvoka."),
        ...
        ("verify_emudesk_password_tip", "Preveri geslo za emudesk"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite emudesk, prekinite klic in program zaprite."),
        ("scam_text2", "emudesk omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("upgrade_emudesk_server_pro_to_{}_tip", "Prosimo, nadgradite emudesk Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo emudesk"),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno emudeska odprto"),
        ...
        ("floating_window_tip", "Pomaga pri emudesk storitvi v ozadju"),
        ...
        ("upgrade_remote_emudesk_client_to_{}_tip", "Prosimo, nadgradite emudesk odjemalec na različico {} ali novejšo na oddaljeni strani."),
        ...
        ("allow-insecure-tls-fallback-tip", "Privzeto emudesk preverja strežniško potrdilo za protokole, ki uporabljajo TLS.\nKo je ta možnost omogočena, bo emudesk ob neuspelem preverjanju preskočil korak preverjanja in nadaljeval."),
        ("Disable UDP", "Onemogoči UDP"),
        ("disable-udp-tip", "Določa, ali naj se uporablja samo TCP.\nKo je ta možnost omogočena, emudesk ne bo več uporabljal UDP 21116, namesto tega bo uporabljen TCP 21116."),
        ("server-oss-not-support-tip", "OPOMBA: Strežnik emudesk OSS ne vključuje te funkcije."),
