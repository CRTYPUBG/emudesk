...
fn check_update(manually: bool) -> ResultType<()> {
    ...
    if update_url.is_empty() {
        ...
        let download_url = if cfg!(feature = "flutter") {
            ...
            format!("{}/emudesk-{}-x86-sciter.exe", download_url, version)
        };
...
mod tests {
    ...
    fn update_download_file_accepts_expected_github_asset_urls() {
        let file = get_download_file_from_url(
            "https://github.com/emudesk/emudesk/releases/download/1.4.0/emudesk-1.4.0-x86_64.dmg",
        )
        .expect("valid GitHub release asset URL");

        assert_eq!(
            file.file_name().and_then(|name| name.to_str()),
            Some("emudesk-1.4.0-x86_64.dmg")
        );
    }
    ...
    fn update_download_file_rejects_untrusted_or_malformed_urls() {
        for url in [
            "http://github.com/emudesk/emudesk/releases/download/1/emudesk.exe",
            "https://example.com/emudesk.exe",
            "https://github.com/other/project/releases/download/1/emudesk.exe",
            "https://github.com/emudesk/emudesk/releases/download/1/",
            "https://github.com/emudesk/emudesk/releases/download/1/nested/emudesk.exe",
            "https://github.com/emudesk/emudesk/releases/download/1/C:emudesk.exe",
            "https://user@github.com/emudesk/emudesk/releases/download/1/emudesk.exe",
            "https://github.com:443/emudesk/emudesk/releases/download/1/emudesk.exe",
            "https://github.com/emudesk/emudesk/releases/download/1/emudesk.exe?download=1",
            "https://github.com/emudesk/emudesk/releases/download/1/emudesk.exe#download",
            "not a url",
        ] {
