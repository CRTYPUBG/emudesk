...
class InputModel {
  ...
  static void initSideButtonChannel() {
    ...
    const channel = MethodChannel('org.emudesk.emudesk/side_buttons');
  ...
  void onPointHoverImage(PointerHoverEvent e) {
    ...
    // May fix https://github.com/emudesk/emudesk/issues/13009
  ...
  static Future<Rect?> fillRemoteCoordsAndGetCurFrame(
    ...
    final coords =
        await emuDeskWinManager.getOtherRemoteWindowCoordsFromMain();
  ...
  static Point<double>? getPointInRemoteRect(
    ...
    // https://github.com/emudesk/emudesk/issues/6678
