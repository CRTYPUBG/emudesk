...
class EmuDeskMultiWindowManager {
  EmuDeskMultiWindowManager._();

  static final instance = EmuDeskMultiWindowManager._();
  ...
  /// `emuDeskWinManager.call(WindowType.Main, kWindowEventHide, {"id": windowId!});`
...
final emuDeskWinManager = EmuDeskMultiWindowManager.instance;
