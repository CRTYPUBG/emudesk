...
class _DesktopTabState extends State<DesktopTab>
  ...
  void onWindowClose() async {
    ...
    if (isMainWindow) {
      if (emuDeskWinManager.getActiveWindows().contains(kMainWindowId)) {
        await emuDeskWinManager.unregisterActiveWindow(kMainWindowId);
      }
